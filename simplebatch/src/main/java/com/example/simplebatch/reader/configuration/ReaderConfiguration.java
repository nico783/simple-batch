package com.example.simplebatch.reader.configuration;
...
@EnableJpaRepositories(
		...
		basePackages = {"com.example.simplebatch.reader.repository"})
public class ReaderConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean readerEntityManagerFactory(
            ...
            @Qualifier("readerDataSource") DataSource barDataSource) {
        return builder
                .dataSource(barDataSource)
                .packages("com.example.simplebatch.reader.entity")
